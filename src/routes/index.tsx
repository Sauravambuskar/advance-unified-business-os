...
> = {
  group: {
    ...
    leads: [
      { name: "Shawon Black", time: "Today at 9:10 AM", email: "shawon@mailzone.io", phone: "(234) 555-0108", camp: "AG-56728", message: "Group-wide inquiry — interested in enterprise plan.", initials: "SB", tone: "bg-[#FEF7E0] text-[#B06000]", stage: "New", stageTone: "bg-[#E8F0FE] text-[#1967D2] ring-[#4285F4]/25" },
      { name: "Kamrul Miles", time: "Today at 9:10 AM", email: "miles87@fastmail.net", phone: "(234) 555-0109", camp: "AG-12131", message: "Requesting proposal across three business units.", initials: "KM", tone: "bg-[#E6F4EA] text-[#188038]", stage: "Qualified", stageTone: "bg-[#FEF7E0] text-[#B06000] ring-[#FBBC05]/25" },
      { name: "Su Flores", time: "Today at 8:10 AM", email: "su.m@quickinbox.org", phone: "(234) 555-0110", camp: "AG-15167", message: "Follow-up on quotation Q-2048.", initials: "SF", tone: "bg-[#E8F0FE] text-[#1967D2]", stage: "Proposal", stageTone: "bg-[#FEF7E0] text-[#B06000] ring-[#FBBC05]/25" },
      { name: "Ma Pena", time: "Today at 7:30 AM", email: "ma.p@inboxmail.com", phone: "(234) 555-0111", camp: "AG-81922", message: "Contract renewal discussion scheduled.", initials: "MP", tone: "bg-[#FCE8E8] text-[#C5221F]", stage: "Won", stageTone: "bg-[#E6F4EA] text-[#188038] ring-[#34A853]/25" },
    ],
    pipeline: [
  ...
  education: {
    ...
    leads: [
      { name: "Priya Naidu", time: "Today at 10:05 AM", email: "priya.n@parent.io", phone: "(234) 555-0210", camp: "ADM-9820", message: "Enquiry for Grade 6 mid-term admission.", initials: "PN", tone: "bg-[#E8F0FE] text-[#1967D2]", stage: "New", stageTone: "bg-[#E8F0FE] text-[#1967D2] ring-[#4285F4]/25" },
      { name: "Daniel Owens", time: "Today at 9:22 AM", email: "d.owens@family.co", phone: "(234) 555-0211", camp: "ADM-9821", message: "Requested campus tour on Saturday.", initials: "DO", tone: "bg-[#E6F4EA] text-[#188038]", stage: "Tour Booked", stageTone: "bg-[#FEF7E0] text-[#B06000] ring-[#FBBC05]/25" },
      { name: "Aisha Rahman", time: "Today at 8:40 AM", email: "aisha.r@mail.net", phone: "(234) 555-0212", camp: "ADM-9822", message: "Scholarship eligibility follow-up.", initials: "AR", tone: "bg-[#FCE8E8] text-[#C5221F]", stage: "Proposal", stageTone: "bg-[#FEF7E0] text-[#B06000] ring-[#FBBC05]/25" },
      { name: "Marco Silva", time: "Yesterday", email: "marco.s@inbox.com", phone: "(234) 555-0213", camp: "ADM-9823", message: "Fee plan accepted — enrollment confirmed.", initials: "MS", tone: "bg-[#FEF7E0] text-[#B06000]", stage: "Enrolled", stageTone: "bg-[#E6F4EA] text-[#188038] ring-[#34A853]/25" },
    ],
    pipeline: [
  ...
  realestate: {
    ...
    leads: [
      { name: "Rahim Ahmed", time: "Today at 9:44 AM", email: "rahim.a@buyer.io", phone: "(234) 555-0310", camp: "PRJ-Skyline", message: "Interested in 3BHK, tower B, sea-facing.", initials: "RA", tone: "bg-[#FEF7E0] text-[#B06000]", stage: "Site Visit", stageTone: "bg-[#FEF7E0] text-[#B06000] ring-[#FBBC05]/25" },
      { name: "Elena Costa", time: "Today at 9:02 AM", email: "elena.c@mail.co", phone: "(234) 555-0311", camp: "PRJ-Greens", message: "Booking amount transferred — awaiting agreement.", initials: "EC", tone: "bg-[#E6F4EA] text-[#188038]", stage: "Booked", stageTone: "bg-[#E6F4EA] text-[#188038] ring-[#34A853]/25" },
      { name: "Yuki Tanaka", time: "Today at 8:15 AM", email: "yuki.t@inbox.jp", phone: "(234) 555-0312", camp: "PRJ-Skyline", message: "Requesting revised floor plan for Unit 12-C.", initials: "YT", tone: "bg-[#E8F0FE] text-[#1967D2]", stage: "Negotiation", stageTone: "bg-[#FEF7E0] text-[#B06000] ring-[#FBBC05]/25" },
      { name: "Omar Farouk", time: "Yesterday", email: "omar.f@fastmail.net", phone: "(234) 555-0313", camp: "PRJ-Palms", message: "New enquiry from Facebook campaign.", initials: "OF", tone: "bg-[#FCE8E8] text-[#C5221F]", stage: "New", stageTone: "bg-[#E8F0FE] text-[#1967D2] ring-[#4285F4]/25" },
    ],
    pipeline: [
  ...
  facility: {
    ...
    leads: [
      { name: "Nordic Ltd.", time: "Today at 9:30 AM", email: "ops@nordic.co", phone: "(234) 555-0410", camp: "SVC-Retail", message: "Extension request — 6 additional retail sites.", initials: "NL", tone: "bg-[#E6F4EA] text-[#188038]", stage: "Proposal", stageTone: "bg-[#FEF7E0] text-[#B06000] ring-[#FBBC05]/25" },
      { name: "Harbor Group", time: "Today at 9:08 AM", email: "pm@harbor.io", phone: "(234) 555-0411", camp: "SVC-HVAC", message: "HVAC AMC renewal for 4 towers.", initials: "HG", tone: "bg-[#E8F0FE] text-[#1967D2]", stage: "Negotiation", stageTone: "bg-[#FEF7E0] text-[#B06000] ring-[#FBBC05]/25" },
      { name: "Peak Retail", time: "Today at 8:52 AM", email: "facilities@peak.com", phone: "(234) 555-0412", camp: "SVC-Cleaning", message: "New enquiry from referral.", initials: "PR", tone: "bg-[#FEF7E0] text-[#B06000]", stage: "New", stageTone: "bg-[#E8F0FE] text-[#1967D2] ring-[#4285F4]/25" },
      { name: "Meridian HQ", time: "Yesterday", email: "admin@meridian.io", phone: "(234) 555-0413", camp: "SVC-Security", message: "Contract signed — onboarding this week.", initials: "MH", tone: "bg-[#FCE8E8] text-[#C5221F]", stage: "Won", stageTone: "bg-[#E6F4EA] text-[#188038] ring-[#34A853]/25" },
    ],
    pipeline: [
                        ...
                        <div className="flex items-center gap-2">
                          <span
                            className={`size-1.5 rounded-full ${
                              ["bg-[#4285F4]", "bg-[#FBBC05]", "bg-[#FBBC05]", "bg-[#FBBC05]", "bg-[#34A853]"][i]
                            }`}
                          />
